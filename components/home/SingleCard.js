function SingleCard(props) {
  return (
    <div className={` flex justify-start  bg-blue-600 text-center hover:to-green-600 mx-auto h-24 sm:h-24 md:h-22 p-2 w-full sm:w-11/12  my-2 rounded-lg shadow-lg `
}>
